<?php /* Smarty version 2.6.13, created on 2019-12-18 21:55:54
         compiled from general/listados.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'general/listados.tpl', 232, false),)), $this); ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "../../conectMin.php", 'smarty_include_vars' => array('pagetitle' => 'example')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>

<!--implementacion Oscar 28.08.2019 para el botón de editar desde la pantalla de pedidos-->
	<?php if ($this->_tpl_vars['tabla'] == 'ZWNfb3JkZW5lc19jb21wcmE=' && $this->_tpl_vars['no_tabla'] == "MQ=="): ?>
...
<!--implementación Oscar 21.08.2019 para recargar salidas en asistencia de usuarios-->
	<?php if ($this->_tpl_vars['tabla'] == 'ZWNfcmVnaXN0cm9fbm9taW5h' && $this->_tpl_vars['no_tabla'] == 'MQ=='): ?>
...
<!--implementación Oscar 30.07.2019 para capturar el historico de productos con estacionalidad por sucursal-->
	<?php if ($this->_tpl_vars['tabla'] == 'c3lzX3N1Y3Vyc2FsZXM=' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
		<?php 
			...
			if($r[0]==1){
				echo '<button type="button" style="position:absolute;border-radius:10px;padding:5px;top:120%;right:20%;"
...
<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM=' && ( $this->_tpl_vars['no_tabla'] == 'NA==' || $this->_tpl_vars['no_tabla'] == 'Mg==' )): ?>
...
<?php if ($this->_tpl_vars['tabla'] == 'ZWNfb2NfcmVjZXBjaW9u' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
...
<?php if ($this->_tpl_vars['tabla'] == 'ZWNfc2VzaW9uX2NhamE='): ?>
	<div style="position: absolute;top:70%;right: 10%;">
	<?php 
		echo $combo_sucs;
	 ?>
	<p style="position:absolute;top:-150px;right:-50px;" align="center"><b>Filtrar por:</b>
...
<div id="campos">
	 <!--<div id="titulo"><?php echo $this->_tpl_vars['datos'][1]; ?>
</div>-->
      <img  class="icono"width="35" height="35" border="0" src="<?php echo $this->_tpl_vars['rooturl'];  echo $this->_tpl_vars['imgMenu']; ?>
"><div id="titulo"><?php echo $this->_tpl_vars['datos'][1]; ?>
</div>
<!--Implementación de Buscador (Oscar)--> 
	 <div id="filtros">
	 	<?php if ($this->_tpl_vars['datos'][11] == '1'): ?>
...
');"><!--Cambio de Oscar 24.05.2018 transf impresas en verde; se envía variable de tabla -->
			</p>
	 	<?php endif; ?>
	 	<?php echo '
	 		<script>
	 			function buscaLista(obj,gr,tabla_list){//se agrega la variable de la tabla de listado para pintar de verde transferencias ya imprimidas Oscar 24.05.2018	
	 				var obj_b=obj.value;
	 				//alert(obj_b.length);
	 				if(obj_b.length<3){
	 					if(obj_b.length<=1){
...
<!--Implmentación de filtros de Fecha en bitácora de sincronización Oscar 14.08.2018-->
		<?php if ($this->_tpl_vars['tabla'] == 'c3lzX21vZHVsb3Nfc2luY3Jvbml6YWNpb24='): ?>
...
"/>
		<table  style="position:relative;left:65%;width:50%;top:-70px;"><tr>
          		<?php if ($this->_tpl_vars['tabla'] == 'ZWNfcGVkaWRvcw==NO'): ?>
          			<td width="70">
          	  ...
          	  <?php if ($this->_tpl_vars['mostrar_nuevo'] == '1' && $this->_tpl_vars['datos'][10] == '1'): ?>		
			  <tr>

			    <td valign="bottom" class="nuevo nuevobtn nuv-img">
               
               <img src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/nuevo.png" alt="Crear Nuevo" border="0"  onclick="abreMod(0,'#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';"/>
          		...
          		<td width="62">				
		            <span id="spryselect1">              
              			<select name="campo" id="campo" >
							<?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['datos'][4],'output' => $this->_tpl_vars['datos'][9]), $this);?>
			...
			<table align="center">
                ...
                <td align="center">
					<table id="listado" cellpadding="0" cellspacing="0" Alto="255"
						   conScroll="S" validaNuevo="false" AltoCelda="25" auxiliar="0" ruta="../../img/grid/" validaElimina="false" Datos="datosListados.php?id_listado=<?php echo $this->_tpl_vars['datos'][0]; ?>
...
$this->_sections['x']['loop'] = is_array($_loop=$this->_tpl_vars['datos'][3]) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>	
								<?php if ($this->_tpl_vars['datos'][3][$this->_sections['x']['index']] == 'ID' || $this->_tpl_vars['datos'][2][$this->_sections['x']['index']] == '0'): ?>
									<td offsetwidth="0" width="0" tipo="oculto" modificable="N" campoBD="<?php echo $this->_tpl_vars['datos'][4][$this->_sections['x']['index']]; ?>
" sentido="ASC"><?php echo $this->_tpl_vars['datos'][9][$this->_sections['x']['index']]; ?>
</td>								
								<?php else: ?>
									<td width="<?php echo $this->_tpl_vars['datos'][2][$this->_sections['x']['index']]; ?>
" offsetWidth="<?php echo $this->_tpl_vars['datos'][2][$this->_sections['x']['index']]; ?>
" align="<?php echo $this->_tpl_vars['datos'][3][$this->_sections['x']['index']]; ?>
" tipo="texto" modificable="N" campoBD="<?php echo $this->_tpl_vars['datos'][4][$this->_sections['x']['index']]; ?>
"><?php echo $this->_tpl_vars['datos'][9][$this->_sections['x']['index']]; ?>
</td>	
								<?php endif; ?>	
							<?php endfor; endif; ?>

						<!--Implementación Oscar 15.04.2017 para Botón para redireccionar a proceso de transferencia-->
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM=' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Continuar" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/autorizarmini.png" width="22" height="22" border="0" onclick="autorizaTrans('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Autorizar" title="De clic para continuar proceso de la transferencia"/>
								</td>
						<!--Fin de cambio Oscar 15.04.2017-->
							<?php endif; ?>

					<!--aqui se genera boton de visualizar-->
							<?php if ($this->_tpl_vars['datos'][5] == '1'): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Ver" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="vermini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/vermini.png" height="22" width="22" border="0"  onclick="abreMod(2,'#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Ver" title="Ver Registro"/>
								</td>
							<?php endif; ?>	
							<?php if ($this->_tpl_vars['datos'][6] == '1' && $this->_tpl_vars['mostrar_mod'] == '1'): ?>
								<td width="62" offsetWidth="56" tipo="libre" valor="<?php if ($this->_tpl_vars['tabla'] == 'ZWNfb3JkZW5lc19jb21wcmE=' && $this->_tpl_vars['no_tabla'] == 'Mg=='): ?>Recibir<?php else: ?>Modificar<?php endif; ?>" align="center" campoBD="<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
">
									<img class="editarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/editarmini.png" width="22" height="22" border="0" onclick="abreMod(1,'#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Mod" title="Modificar Registro"/>
								</td>
							<?php endif; ?>
					<!--Aqui modificar condicion para deshabilitar eliminado de transfer-->
						<!---->
							<?php if ($this->_tpl_vars['datos'][7] == '1' && $this->_tpl_vars['mostrar_eli'] == '1' && $this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM='): ?><!---->
                				<td width="55" offsetWidth="55" tipo="libre" valor="Eliminar" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="eliminarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/eliminarmini.png" width="22" height="22" border="0" onclick="cancelarTransfer(3,'#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Eliminar" title="Eliminar Transferencia"/>
								</td>
							<?php endif; ?><!--fin de cambio 27.05.2018-->

							<?php if ($this->_tpl_vars['datos'][7] == '1' && $this->_tpl_vars['mostrar_eli'] == '1' && $this->_tpl_vars['tabla'] != 'ZWNfdHJhbnNmZXJlbmNpYXM='): ?>
                				<td width="55" offsetWidth="55" tipo="libre" valor="Eliminar" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="eliminarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/eliminarmini.png" width="22" height="22" border="0" onclick="abreMod(3,'#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Eliminar" title="Eliminar Registro"/>
								</td>
			                <?php endif; ?>
			
							<?php if (( $this->_tpl_vars['tabla'] == 'ZWNfb3JkZW5lc19jb21wcmE=NOVA' || ( $this->_tpl_vars['tabla'] == 'ZWNfcGVkaWRvcw==' && $this->_tpl_vars['no_tabla'] == 'MA==' ) || ( $this->_tpl_vars['tabla'] == 'ZWNfcGVkaWRvcw==' && $this->_tpl_vars['no_tabla'] == 'MQ==' ) ) && $this->_tpl_vars['mostrar_imp'] == '1'): ?>
                				<td width="56" offsetWidth="56" tipo="libre" valor="Imprimir" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="imprimirmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/imprimirmini.png" width="22" height="22" border="0" onclick="imprimirCot('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Imprimir" title="imprimir Registro"/>
								</td>
			                <?php endif; ?>
			                
			                <?php if (( $this->_tpl_vars['tabla'] == 'ZWNfb3JkZW5lc19jb21wcmE=' && $this->_tpl_vars['no_tabla'] == 'MA==' ) || ( $this->_tpl_vars['tabla'] == 'ZWNfcGVkaWRvcw==NOVER' && $this->_tpl_vars['no_tabla'] == 'MA==' )): ?>
                				<td width="56" offsetWidth="56" tipo="libre" valor="Autorizar" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/autorizarmini.png" width="22" height="22" border="0" onclick="autorizaCot('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Autorizar" title="imprimir Registro"/>
								</td>
			                <?php endif; ?>
			                <?php if ($this->_tpl_vars['tabla'] == 'ZWNfcGVkaWRvcw==NOVER' && $this->_tpl_vars['no_tabla'] == 'MQ=='): ?>
                				<td width="56" offsetWidth="56" tipo="libre" valor="Facturar" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="facturarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/imprimirmini.png" width="22" height="22" border="0" onclick="facturar('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Facturar" title="facturar Nota de Venta"/>
								</td>
			                <?php endif; ?>
...
'>
									<img class="imprimirmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/imprimirmini.png" width="22" height="22" border="0" onclick="imprimeTrans('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Autorizar" title="De clic para imprimir la transferencia"/>
								</td>
							<?php endif; ?>
							
							
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM=' && $this->_tpl_vars['no_tabla'] == 'MQ=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Dar salida" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/autorizarmini.png" width="22" height="22" border="0" onclick="salidaTrans('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Dar salida" title="De clic para dar salida a la transferencia"/>
								</td>
							<?php endif; ?>
					<!--Aqui es el boton de recepcion de Transferencias-->
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM=' && $this->_tpl_vars['no_tabla'] == 'Mg=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Dar recepción" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/autorizarmini.png" width="22" height="22" border="0" onclick="recepcionTrans('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Dar salida" title="De clic para dar recepción a la transferencia"/>
								</td>
							<?php endif; ?>
							
							
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM=' && $this->_tpl_vars['no_tabla'] == 'Mw=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Verificar" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/autorizarmini.png" width="22" height="22" border="0" onclick="varificarTrans('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Dar salida" title="De clic para verificar la transferencia"/>
								</td>
							<?php endif; ?>

							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM=' && $this->_tpl_vars['no_tabla'] == 'NA=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Resolver" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/autorizarmini.png" width="22" height="22" border="0" onclick="resolverTrans('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Dar salida" title="De clic para darle resolución a la transferencia"/>
								</td>
							<?php endif; ?>
							
							
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfZGV2b2x1Y2lvbl90cmFuc2ZlcmVuY2lh' && $this->_tpl_vars['no_tabla'] == 'MQ=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Resolver" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/autorizarmini.png" width="22" height="22" border="0" onclick="resolverDev('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Dar salida" title="De clic para darle resolución a la devolución"/>
								</td>
							<?php endif; ?>
							<!-- ********************** BOTON FACTURAR EN VENTAS ******************************-->
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdmVudGFz' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
								<td width="65" offsetWidth="65" tipo="libre" valor="Facturar" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/autorizarmini.png" width="22" height="22" border="0" onclick="factura('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Facturar" title="De clic para facturar"/>
								</td>
							<?php endif; ?>
...
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/autorizarmini.png" width="22" height="22" border="0" onclick="enviarMail('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Facturar" title="De clic para facturar"/>
								</td>
							<?php endif; ?>
			<!--Implementación Oscar 21.02.2019 para agregar botón de reimpresión de resolución de Transferencias-->
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM=' && $this->_tpl_vars['no_tabla'] == 'NQ=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Imprimir" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="imprimirmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/impresion_tkt.png" width="22" height="22" border="0" onclick="imprimeTicketTrans('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Autorizar" title="De clic para imprimir ticket de resolucion"/>
								</td>
							<?php endif; ?>
			...
			<!--Implementación Oscar 22.02.2019 para agregar botón de impresión de Transferencias en ticket-->
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYXM=' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Ticket" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="imprimirmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/impresion_tkt.png" width="22" height="22" border="0" onclick="imprimeTicketTrans('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Autorizar" title="De clic para imprimir ticket de resolucion"/>
								</td>
			...
			<!--Implementación Oscar 03.03.2019 para agregar botón de impresión de Transferencias en ticket-->
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfZGV2b2x1Y2lvbg==' && $this->_tpl_vars['no_tabla'] == 'MQ=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Terminar" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="imprimirmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/ir.png" width="22" height="22" border="0" onclick="continua_devolucion('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Autorizar" title="De Click para continuar con el proceso de esta devolución"/>
								</td>
							<?php endif; ?>
			<!--Fin de cambio Oscar 03.03.2019-->

			<!--Implementación Oscar 24.03.2019 para agregar botón de enviar a exclusión de trasferencias-->
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfdHJhbnNmZXJlbmNpYV9yYWNpb25lcw==' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
								<td width="56" offsetWidth="56" tipo="libre" valor="Excluir" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="imprimirmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/ir.png" width="22" height="22" border="0" onclick="envia_exclusion('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Autorizar" title="De Click para enviar esta producto a exclusión de Transferencias"/>
								</td>
							<?php endif; ?>
			<!--Fin de cambio Oscar 24.03.2019-->

			<!--implementacion Oscar 19.08.2019 para el botón de impresión de credencial de usuario-->
						<?php if ($this->_tpl_vars['tabla'] == 'c3lzX3VzZXJz' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
							<td width="56" offsetWidth="56" tipo="libre" valor="imp Cred" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/especiales/credencial_usuario.png" width="22" height="22" border="0" onclick="imprimeCredencial('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Autorizar" title="De clic para imprimir credencial de usuario"/>
							</td>
						<?php endif; ?>
			...
			<!--implementacion Oscar 28.08.2019 para el botón de editar desde la pantalla de pedidos-->
						<?php if ($this->_tpl_vars['tabla'] == 'ZWNfb3JkZW5lc19jb21wcmE=' && $this->_tpl_vars['no_tabla'] == "MQ=="): ?>
							<td width="56" offsetWidth="56" tipo="libre" valor="Edit Pedido" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/especiales/edita.png" width="22" height="22" border="0" onclick="abrePedido('#',1);" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Autorizar" title="De clic para editar desde la pantalla de pedidos"/>
							</td>
						<?php endif; ?>
			<!--Fin de cambio Oscar 28.08.2019-->
							...
							<?php if ($this->_tpl_vars['tabla'] == 'ZWNfb2NfcmVjZXBjaW9u' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
								<td width="65" offsetWidth="65" tipo="libre" valor="Pagos" align="center" campoBD='<?php echo $this->_tpl_vars['valuesEncGrid'][$this->_sections['x']['index']]; ?>
'>
									<img class="autorizarmini" src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/autorizarmini.png" width="22" height="22" border="0" onclick="enviarMail('#')" onmouseover="this.style.cursor='hand';this.style.cursor='pointer';" alt="Facturar" title="De clic para facturar"/>
								</td>
						...
						<!--Implementación de Oscar para botónes de importar y exportar productos 11.04.2018-->
							...
							<?php if ($this->_tpl_vars['datos'][0] == '12'): ?>
				  ...
				  <script>	
					CargaGrid('listado','<?php echo $this->_tpl_vars['tabla']; ?>
');
						
						<?php if ($this->_tpl_vars['tabla'] == 'ZWNfcHJvZHVjdG9z'): ?>
							ordena(2, 'listado','<?php echo $this->_tpl_vars['tabla']; ?>
');
					    <?php else: ?>
							ordena(1, 'listado','<?php echo $this->_tpl_vars['tabla']; ?>
');//se agrega variable tabla para transf impresas en Verde Oscar 25.05.2018
						<?php endif; ?>
				  </script>
				</tr>
			</table>
...
<!--Implementación Oscar 27.09.2018 para exportar/importar todas las estacionalidades-->
		<?php if ($this->_tpl_vars['tabla'] == 'ZWNfZXN0YWNpb25hbGlkYWQ=' && $this->_tpl_vars['no_tabla'] == 'MA=='): ?>
...
<!--Fin de cambio 27.09.2018-->
	...
	/**/
		...
		function recarga_corte(){
			var filt_sucs,filt_tipo,filtros_adicionales="&fltros_adic=";
		//sacamos los filtros
	...
	/*implementacion Oscar 24.10.2019 para no dejar abrir ciertas pantallas localmente*/
			if(( (tabla == "c3lzX3VzZXJz" && (no_tabla == "MA==" || no_tabla == "MQ==")) 
				...
				'; ?>
					...
					if("<?php echo $this->_tpl_vars['tipo_sistema']; ?>
"!='linea')
					<?php echo '
					{
	...
	/*Fin de camio Oscar 24.10.2019*/
			...
			if(tabla == \'ZWNfbWFxdWlsYQ==\' && tipo == 3){
				...
				if(confirm("<?php echo $this->_tpl_vars['letMaquila']; ?>
"))
				<?php echo '
				{
			...
			//verificamos si corresponde a transferencia el boton y mandamos id de transferencia en caso de cumplir condiciones
				if(tabla==\'ZWNfdHJhbnNmZXJlbmNpYXM=\' && tipo==2 && no_tabla=="MA=="){
					//alert(\'0*0\');
					location.href="../especiales/Transferencias/nuevaTransferencia.php?idTransfer="+id;
					return false;
				} 
		...
		/*Fin de cambio Oscar 14.12.2019*/
						...
						if(aux_trsnf[0]!=\'ok\'){
							alert("Error al verificar transferencias pendienetes!!!");
							return true;
						}
						if(aux_trsnf[1]!=\'ok\'){
					...
					/*deshabilitado por oscar 01.05.2018
						$.ajax({
							...
							url="../especiales/Transferencias/transf.php";
							location.href=url;
							/*return false;
							}
						});
...
<div class="mensajesPop" id="mensajesPop" style="display:none">
	<div class="ventanaMens">
		<?php echo $this->_tpl_vars['letAutTrans']; ?>
