<?php /* Smarty version 2.6.13, created on 2019-08-14 14:31:46
...
/**/
	...
	//enviamos datos por ajax
		'; ?>
			...
			url="<?php echo $this->_tpl_vars['rooturl']; ?>
/code/ajax/buscadorMenus.php?";
			sub_url="<?php echo $this->_tpl_vars['rooturl']; ?>
";
...
<!-- Boton redireccion a catalogo web-->
	<button style="width: 125px; height: 125px; position: absolute; left: 45%; top: 70px; background-color: brown; color: white; border: 0; border-radius: 50%; cursor: pointer; outline: none;" onclick="window.open('<?php echo $this->_tpl_vars['rooturl']; ?>
../pagina/productos.php');"><img src="<?php echo $this->_tpl_vars['rooturl']; ?>
img/icono-catalogo.png" style="width: 75%; height: 75%;"><br>Catálogo</button>
