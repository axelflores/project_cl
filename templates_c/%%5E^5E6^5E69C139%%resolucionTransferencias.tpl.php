<?php /* Smarty version 2.6.13, created on 2019-12-20 09:31:37
         compiled from especiales/resolucionTransferencias.tpl */ ?>
...
$this->_smarty_include(array('smarty_include_tpl_file' => "_headerResolucion.tpl", 'smarty_include_vars' => array('pagetitle' => ($this->_tpl_vars['contentheader']))));
				...
				<fieldset>
					...
					<table>
						<tr>
							...
							<td>&nbsp;</td>
							<td ><b><?php echo $this->_tpl_vars['folio']; ?>
</b></td>
						</tr>
						<tr>
							<td class="texto_form">Fecha y hora</td>
							<td>&nbsp;</td>
							<td><b><?php echo $this->_tpl_vars['fechahora']; ?>
</b></td>
						</tr>
						<tr>
							<td class="texto_form">Sucursal de origen</td>
							<td>&nbsp;</td>
							<td><b><?php echo $this->_tpl_vars['sucursal_or']; ?>
</b></td>
						</tr>
						<tr>
							<td class="texto_form">Almac&eacute;n de origen</td>
							<td>&nbsp;</td>
							<td><b><?php echo $this->_tpl_vars['alma_or']; ?>
</b></td>
						</tr>
						<tr>
							<td class="texto_form">Sucursal destino</td>
							<td>&nbsp;</td>
							<td><b><?php echo $this->_tpl_vars['sucursal_des']; ?>
</b></td>
						</tr>
						<tr>
							<td class="texto_form">Almac&eacute;n destino</td>
							<td>&nbsp;</td>
							<td><b><?php echo $this->_tpl_vars['alma_des']; ?>
</b></td>
						</tr>
						<tr>
							<td class="texto_form">Creada por</td>
							<td>&nbsp;</td>
							<td><b><?php echo $this->_tpl_vars['creadapor']; ?>
</b></td>
						</tr>
					</table>
				</fieldset>	
...
<!--Implemetación Oscar 25.02.2019 para buscador de productos en la resolución-->
    <div id="emergente_resolucion" style="position: fixed;width: 100%;height: 100%;left:0;top:0;background: rgba(0,0,0,.7);z-index: 100;display: none;"><br><br><br><br>
    	<div style="color: white;font-size:25px;" align="center">
    		...
    		<br>
    		<button style="padding: 10px;" onclick="verificar_pss();">Aceptar</button>
...
<!--Fin de cambio Oscar 25.02.2019-->
		...
		<!--Fin de cambio Oscar 25.02.2019-->
 			<div id="cosa" align="center"> 				
 				<table id="transferenciasProductos" cellpadding="0" cellspacing="0" border="1" Alto="250" conScroll="S" validaNuevo="false" despuesInsertar="" AltoCelda="25" auxiliar="0" ruta="../../img/grid/" validaElimina="false" Datos="../ajax/getDatosDif.php?id=<?php echo $this->_tpl_vars['llave']; ?>
" verFooter="N" guardaEn="" listado="N" class="tabla_Grid_RC" scrollH="N" despuesEliminar="" >
					<tr class="HeaderCell">                      
...
img/icono_ok.png" width="22" height="22" onclick="valida_tipo_resolucion('#')">
						</td>
...
//       	transferenciasProductos_1_0
	...
	function segunda_busqueda(id_prod){
		'; ?>
var id_trasnf_orig=<?php echo $this->_tpl_vars['llave']; ?>
;<?php echo '
...
;<?php echo '
			...
			//alert(url);return false;
			var ax=url.split(\'|\');
			if(ax[0]!=\'ok\'){alert(url);return false;}else{
