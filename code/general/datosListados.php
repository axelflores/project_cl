...
//Buscamos los datos de configuracion del listado
	...
	if(($datList['tabla'] == 'ec_ordenes_compraNOVA' || ($datList['tabla'] == 'ec_pedidos' && $datList['no_tabla'] == 0)
	   || $datList['tabla'] == 'ec_movimiento_almacenNOVA' || ($datList['tabla'] == 'ec_pedidos' && $datList['no_tabla'] == 1))
	  && $mostrar_imp == '1')
	...
	{
		$consulta=str_replace("FROM ".$datList['tabla'], ", 'aut' FROM ".$datList['tabla'], $consulta);
		$consulta=str_replace("FROM ".$datList['tabla'], ", 'imp','imp' FROM ".$datList['tabla'], $consulta);
	}
