...
//armamos la consulta
	...
	$eje=mysql_query($sql)or die("Error al consultar Trnasferencias Pendienetes!!!\n\n".$sql."\n\n".mysql_error());
...
//generamos botón para continuar
	$res.='<br><button type="button" class="bt_continua" style="left:-10%;position:relative;" onclick="location.href=\'../especiales/Transferencias/transf.php\';">Continuar de todas formas</button>';	
