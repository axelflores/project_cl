<?php
	...
	$smarty->assign("let1", utf8_decode("Este cambio sera irreversible y afectará la transferencia y el inventario.¿desea continuar?"));
	$smarty->assign("let2", utf8_decode("No aplica este tipo de resolucion"));
	$smarty->assign("msg_devuelve",utf8_encode("LLEGO PRODUCTO DE MAS Y SE DEVOLVERA FISICAMENTE AL ALMACEN DE ORIGEN!"));
	$smarty->assign("msg_mantiene",utf8_encode("LLEGO PRODUCTO DE MAS Y SE QUEDARA EN LA SUCURSAL, O LLEGO PRODUCTO DE MENOS!"));
