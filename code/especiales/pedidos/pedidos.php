...
<html>
<head>
	<title>Pantalla de Compras</title>
<style>
	*{
		margin:0;
	}
  ...
  padding: 10px;
	...
	#simula_tooltip{position:fixed;width: 30%;max-height:40%;background: white;border:2px solid gray;top:0;z-index: 5000;
		display: none; border-radius: 0 20px 20px 20px;overflow-y:auto;top:0;
	}
			...
			<table width="100%" border="0">
				...
				<!--Proveedores-->
					...
					<p style="position:relative;top:0;" class="subtitulo"><b>Proveedores:</b></p>
						<input type="button" value="Mostrar" onclick="ver_lista_prov(1);" style="padding:8px;">
