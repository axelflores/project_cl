...
if($id_oc!=0){
    ...
    /*16es_nuevo*/ax.pedidoPzas
		...
		/**/	/**/	/**/	FROM(
		/**/	/**/	/**/	/**/SELECT
										ocd.id_producto,/*id del producto desde el detalle de la órden de cmompra*/
										...
										ocd.precio as precioMinimo,/*precio del proveedor */
...
/*fin de cambio Oscar 29.08.2019*/
	...
	$eje=mysql_query($sql)or die("Error al calcular pedido\n\n".mysql_error()."\n\n".$sql);		
...
//				}
		...
		//asignamos combo o caja de texto dependienedo si es órden de compra nueva o modificación
			...
			if($id_oc==0||$id_oc!=0){
				echo '<td width="7%" align="center" id="config_'.$c.'"><input type="button" onclick="adm_prov_prod('.$r[0].');" style="display:none;" id="b1_'.$c.'">'.
				'<img src="../../../img/especiales/config';
