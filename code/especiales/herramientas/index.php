...
<!--		<center><span>Consultas Prediseñadas</span></center>-->
		<div id="izquierda">
			...
			<?php
				...
				while($r=mysql_fetch_row($eje)){
					echo '<tr>';
						echo '<td>';
							echo '<button onclick="carga_filtros('.$r[0].',\'busc_prod\');" class="opc_btn" id="btn_1" title="'.$r[2].'">';
							echo $r[1];
							echo '</button>';
						echo '</td>';
					echo '</tr>';
		...
		<!--botones para modificar y agregar consultas-->
				<table class="btns">
					<tr>
						<td>
							<button id="edita_consulta" onclick="carga_form(-1);" class="btn_opc">
								Editar
							</button>
						</td>
					</tr>
