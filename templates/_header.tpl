...
<!-- Boton redireccion a catalogo web-->
	<button style="width: 125px; height: 125px; position: absolute; left: 45%; top: 70px; background-color: brown; color: white; border: 0; border-radius: 50%; cursor: pointer; outline: none;" onclick="window.open('{$rooturl}../pagina/productos.php');"><img src="{$rooturl}img/icono-catalogo.png" style="width: 75%; height: 75%;"><br>Catálogo</button>
...
<header>
 	...
 	<div class="logoheader">
		<a href="{$rooturl}index.php">
			<img src="{$rooturl}img/img_casadelasluces/logocasadelasluces-easy.png"/>
		</a>
	</div>
    <!--Usuarios y sucursal-->
