...
<!--implementación Oscar 30.07.2019 para capturar el historico de productos con estacionalidad por sucursal-->
	{if $tabla eq 'c3lzX3N1Y3Vyc2FsZXM=' && $no_tabla eq 'MA=='}
		{php}
	 ...
	 <div id="filtros">
	 	{if $datos[11] eq '1'}
	 		<p align="left" style=""><b>Buscador:</b>
				<input type="text" style="width:50%;" onkeyup="buscaLista(this,'{$datos[0]}','{$tabla}');"><!--Cambio de Oscar 24.05.2018 transf impresas en verde; se envía variable de tabla -->
			</p>
	 	{/if}
	 	{literal}
	 		<script>
